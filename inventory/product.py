...
class Product:
    ...
    def __init__(self, product_name, quantity, price, category, file_path = "/home/dci-student/Projects/exercises/scr/Inventory_Management_System/inventory/product_catalog.json"):
