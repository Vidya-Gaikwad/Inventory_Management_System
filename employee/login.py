import bcrypt
from employee.users_database import UserManager
from employee.validate_user import ValidationError
...
class Login:
    ...
    def validate_password(self, input_password, stored_hashed_password):
        ...
        # return bcrypt.checkpw(input_password.encode(), stored_hashed_password) # old
          # Ensure proper encoding (UTF-8) before passing it to bcrypt.checkpw
